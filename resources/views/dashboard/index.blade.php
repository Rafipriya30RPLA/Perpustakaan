            ...
            <div class="col-12 col-xl-4">
                <div class="justify-content-end d-flex">
                    <div class=" flex-md-grow-1 flex-xl-grow-0">
                        <button class="btn btn-sm btn-info  " aria-haspopup="true" aria-expanded="true">
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                            <div class="card-body">
                                ...
                                <p class="fs-30 mb-2">{{ app('App\Http\Controllers\DashboardController')->hitungStok() }}
                                </p>
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-dark-blue">
                            <div class="card-body">
                                ...
                                <p class="fs-30 mb-2">
                                    {{ app('App\Http\Controllers\DashboardController')->hitungPeminjam() }}</p>
                    ...
                    <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                        <div class="card card-light-blue">
                            <div class="card-body">
                                ...
                                <p class="fs-30 mb-2">
                                    {{ app('App\Http\Controllers\DashboardController')->hitungNamabuku() }}</p>
                                <p>Total Nama Buku</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 stretch-card transparent">
                        <div class="card card-light-danger">
                            <div class="card-body">
                                ...
                                <p class="fs-30 mb-2">
                                    {{ app('App\Http\Controllers\DashboardController')->hitungPengguna() }}</p>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            @if ($row->status === 'pending')
                                                                @if (Carbon\Carbon::now() > Carbon\Carbon::parse($row->tenggat))
                                                                    <button type="button"
                                                                        class="btn btn-outline-danger mr-1 approve-btn"
                                                                        data-id="{{ $row->id }}">Telat</button>
                                                                @else
                                                                    <button type="button"
                                                                        class="btn btn-outline-danger mr-1 approve-btn"
                                                                        data-id="{{ $row->id }}">Menunggu
                                                                        Persetujuan</button>
                                                                @endif
                                                            @endif
                                                            ...
                                                            @if ($row->status === 'acc')
                                                                @if (Carbon\Carbon::now() > Carbon\Carbon::parse($row->tenggat))
                                                                    <button type="button"
                                                                        ...
                                                                        data-id="{{ $row->id }}">Telat</button>
                                                                @else
                                                                    <button type of="button"
                                                                        class="btn btn-outline-primary mr-1 approve-btn"
                                                                        data-id="{{ $row->id }}">Sedang
                                                                        Dipinjam</button>
                                                                @endif
                                                            @endif
                                                        </div>
