...
<!-- Mirrored from themestarz.net/html/finwin/index-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Oct 2023 13:32:13 GMT -->
<head>
	<meta charset="UTF-8">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top ts-separate-bg-element" data-bg-color="#141a3a">
                <div class="container">
                    <a class="navbar-brand" href="#page-top">
                        <img src="{{asset('login.png')}}" width="200" alt="">
                    </a>
                    <!--end navbar-brand-->
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav ml-auto">
                            <a class="ts-scroll btn btn-primary btn-sm m-1 px-3 ts-width__auto" href="#form-contact">Lanjutkan</a>
                        </div>
                        <!--end navbar-nav-->
                    </div>
                    <!--end collapse-->
...
@include('swal')
            ...
            <div class="container align-self-center align-items-center">
                <div class="row">
                    <div class="col-md-7">
                        <h2 data-animate="ts-fadeInUp">Blue-Book Indonesia</h2>
                        <div data-animate="ts-fadeInUp" data-delay=".1s">
                            <p class="w-75 text-white mb-5 ts-opacity__50">Perpustakaan Berbasis Web</p>
                        </div>
                        <a href="/daftarbuku" class="btn btn-primary btn-lg ts-scroll mr-4" data-animate="ts-fadeInUp" data-delay=".2s">
                            Lanjutkan
            ...
            <div class="ts-background" data-bg-color="#141a3a" data-bg-parallax="scroll" data-bg-parallax-speed="3">
                ...
                <div class="ts-background-image ts-parallax-element" data-bg-image="assets/img/perpus3.jpg" data-animate="ts-zoomOutIn"></div>
            </div>
            <!--END HERO BACKGROUND *********************************************************************************-->
...
<!-- Mirrored from themestarz.net/html/finwin/index-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Oct 2023 13:33:04 GMT -->
</html>
