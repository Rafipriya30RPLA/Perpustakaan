                ...
                <form action="{{route('penerbit.store')}}"method="POST" enctype="multipart/form-data">
                    ...
                    <script>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="number" name="no_telepon"  value="{{old('no_telepon')}}"class="form-control @error('no_telepon')is-invalid
                        @enderror" id="">
                      </div>
                      @error('no_telepon')
                      <script>
                      ...
                      <div class="mb-3">
                          ...
                          <textarea type="text" name="alamat" value="{{old('alamat')}}" class="form-control @error('alamat')is-invalid
